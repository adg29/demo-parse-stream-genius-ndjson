...
describe('Section Parser', () => {
    ...
    it.skip('matchSections lumps section with no section header at all', () => {})
    it.skip('attributeSectionWords increments word count by 1 for #Artist that uses #Word across different sections', () => {})
})